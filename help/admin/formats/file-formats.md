...
Elenca le macro utilizzabili per creare file di dati basati su [!DNL FTP]. Alcune macro possono essere utilizzate per tutti i campi e le righe del file di dati. Altre macro sono specifiche solo per righe di intestazione e dati.

## Macro comuni {#common-macros}

Tali macro possono essere utilizzate in qualsiasi campo di formato. Per gli esempi, vedere [File Format Macro Examples](../formats/file-format-examples.md).
...
<table id="table_A3309E175ABF4651BD11CE3632B3C553"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Alias per un ID ordine/destinazione. </p> <p>Il valore di questo alias è impostato nel campo <span class="wintitle"> ID conto esterno </span> di una destinazione (nella sezione <span class="wintitle"> Impostazioni di base </span>). </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Una marca temporale di 10 cifre, UTC e Unix. </p> <p>Può anche essere formattato come <code>YYYYMMDDhhmmss</code> in seguito alle regole di formattazione Java data/timestamp. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Macro utilizzate solo nei campi di intestazione. Per gli esempi, vedere [File Format Macro Examples](../formats/file-format-examples.md).
...
Macro utilizzate solo nelle righe di dati. Per gli esempi, vedere [File Format Macro Examples](../formats/file-format-examples.md).
...
<table id="table_E378F94A3907407AA8110C8EE6C10909"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="term"> Identificatore Utente Univoco Partner Dati  </span>. Restituisce l'ID assegnato a un visitatore utente/sito se tale ID è già stato sincronizzato con un ID dispositivo <span class="keyword">  Audience Manager </span>. </p> <p>Se il DPID è 0, questa macro restituirà l'ID <span class="keyword">  Audience Manager </span> invece dell'ID dell'utente. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Questa combinazione di macro crea un'istruzione condizionale in cui sono elencati i segmenti di appartenenza degli utenti a <i>e</i> sono stati rimossi. Restituisce una stringa vuota se entrambe le condizioni non sono soddisfatte o se non sono presenti dati. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>ID partner (PID). Il PID viene visualizzato nella scheda <span class="wintitle"> Profilo </span> dell'interfaccia utente di amministrazione. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Restituisce un elenco di segmenti in un elenco. Accetta le seguenti variabili facoltative: </p> 
    <ul id="ul_B111AA0D6C18445598A1444B8B7E9325"> 
     <li id="li_8603B40229624856AF1FBC434DB8F16A"> <code>segmentId</code>: ID legacy. Obsoleto. Utilizzate <code>sid</code> (solo lettere minuscole). </li> 
     <li id="li_1EF40DDCA3C5447586904CF021D8F912"> <code>csegid</code>: ID legacy. Obsoleto. Utilizzate <code>sid</code> (solo lettere minuscole). </li> 
     ...
     <li id="li_FE5049089F2944FA9DB9F9D546DBA167"> <code>alias</code>: Mapping del segmento. Obsoleto. Utilizzate <code>sid</code> (solo lettere minuscole). </li> 
